...
path = os.path.join(script_dir, "flood_xgboost_model.pkl")
model = joblib.load(path)
print('Model Loaded Successfully')

# Load background image 
image_path = os.path.join(script_dir, "flood_img.jpeg")
...
print('Title and Header Set Successfully')
...
# Input Features
st.sidebar.header("Adjust Flood Risk Factors (0 = Low, 19 = Extreme)")
